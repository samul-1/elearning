...
class Question(models.Model):
    ...
    solution_text_source = models.TextField(default="")
    ...
    def save(self, *args, **kwargs):
        self.source_text = (
            self.text
        )  # this is the text that was originally input (used when editing question)
        self.text = tex_to_svg(self.text)

        self.solution_text_source = self.solution_text
        self.solution_text = tex_to_svg(self.solution_text)
    ...
    def format_question_for_user(self):
        output = {}
        output["text"] = self.text  # str(tex_to_svg(self.text))  # !
    ...
    def format_complete_question(self):
        ...
        info["textSource"] = self.source_text
        info["solution"] = self.solution_text
        info["solutionSource"] = self.solution_text_source
        ...
        info["answersSources"] = [a.source_text for a in list(answers_sources)]
        return info
